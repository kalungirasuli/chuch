...
export function Newsletter(){
    return(
        ...
        <Alert type="error" title="Error" message="You have not successfully registered, please try again" />
           ...
           <div className="div p-5  lg:w-[90%]  m-auto xl:w-[80%]">
                ...
                <div className="div backdrop-blur-[10px] bg-brown/30 p-4 rounded-[10px] w-[90%] m-auto md:w-[60%] md:p-5 ml-0  lg:p-10 lg:rounded-[20px] lg:w-[600px] flex flex-col ">
